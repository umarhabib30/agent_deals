...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/admin/assets/vendor/datatables/css/dataTables.bootstrap4.css') }}" />
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/admin/assets/vendor/datatables/css/buttons.bootstrap4.css') }}" />
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/admin/assets/vendor/datatables/css/select.bootstrap4.css') }}" />
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/admin/assets/vendor/datatables/css/fixedHeader.bootstrap4.css') }}" />
    ...
    <div class="dashboard-main-wrapper">
        ...
        <div class="dashboard-header">
            <nav class="navbar navbar-expand-lg bg-white fixed-top">
                <a class="navbar-brand" href="{{ route('admin.dashboard') }}"><img src="{{ asset('assets/images/logo_main2.svg') }}" style="width: 80%" alt=""></a>
                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link @if ($active == 'dashboard') active @endif" href="{{ route('admin.dashboard') }}"><i class="fa fa-fw fa-user-circle"></i>Dashboard <span class="badge badge-success">6</span></a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link @if ($active == 'deals') active @endif" href="{{ route('admin.deals') }}"><i class="fa fa-fw fa-rocket"></i>Deals</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link  @if ($active == 'users') active @endif" href="{{ route('admin.users') }}" ><i class="fas fa-fw fa-chart-pie"></i>Users</a>
                            </li>
                        </ul>
                    </div>
                </nav>
