                    ...
                    <div class="tab-pane" id="messages" role="tabpanel" aria-labelledby="messages-tab" tabindex="0">
                        ...
                        <div class="verify-box w-50 mt-4">
                            ...
                            <div class="mt-4">
                                ...
                                <button class="btn-green btn verify-emirates-id" @if ($user->is_emirate_verified == 1) disabled

                                @endif>Verify Emirates ID</button>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="modal-body">
                    <form id="uploadForm" action="{{ route('emirate.upload') }}" method="POST"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="file" name="emirates_id" class="form-control" id="fileInput"
                                accept="image/*">
                        </div>
                        <div class="text-end">
