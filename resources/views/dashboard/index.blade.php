        ...
        <div class="col-lg-3 col-md-6 col-sm-12 lasdkf">
            <div class="light-green d-flex justify-content-between p-3 border-radius">
                ...
                <div>
                    ...
                    <p class="mb-0 text-end">AED 1234</p>
                </div>
            </div>
        </div>
        <div class="col-lg-3 col-md-6 col-sm-12 lasdkf">
                ...
                <form id="multi-step-form" action="{{ route('deal.store') }}" method="POST">
                    ...
                    <div class="step step-1">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-controls w-100 fw-bold" value="Off plan" id="field1"
                                name="project_type" readonly>
                        </div>
                        <div class="mb-3">
                            <label for="field1" class="form-label">Project Name</label>
                            <input type="text" class="form-controls w-100" id="field1" placeholder="Enter project name"
                                name="project_name">
                        </div>
                        <div class="mb-3">
                    ...
                    <div class="step step-2">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-controls w-100" id="brokerageName" name="brokerage_name"
                                    value="Livstate Real Estate Brokerage L.L.C" readonly>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="iban" class="form-label"><span class="text-danger">*</span> IBAN
                                    Number</label>
                                <input type="text" class="form-controls w-100" id="iban" placeholder="Enter IBAN number"
                                    name="iban_number" required>
                        ...
                        <div class="row">
                            <!-- Account Holder Name -->
                            <div class="col-md-6 mb-3">
                                <label for="accountHolder" class="form-label"><span class="text-danger">*</span> Account
                                    Holder Name</label>
                                <input type="text" class="form-controls w-100" id="accountHolder"
                                    placeholder="Enter account holder's full name" name="account_holder_name" required>
                    ...
                    <div class="step step-4">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control" name="closing_date" id="closingDate" value=""
                                value="closing_date">
                        </div>
