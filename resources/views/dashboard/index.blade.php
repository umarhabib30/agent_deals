            ...
            <div class="col-lg-3 col-md-6 col-sm-12">
                <div class="light-green d-flex justify-content-between p-3 border-radius">
                    ...
                    <div>
                        ...
                        <p class="mb-0 text-end">{{ $deal_count }}</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-12 lasdkf">
                <div class="light-green d-flex justify-content-between p-3 border-radius">
                    ...
                    <div>
                        ...
                        <p class="mb-0 text-end">AED {{ $total_sales }}</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-12 lasdkf">
                <div class="light-green d-flex justify-content-between p-3 border-radius">
                    ...
                    <div>
                        ...
                        <p class="mb-0 text-end">AED {{ $last_payout->amount ?? 0 }}</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-12 lasdkf">
                <div class="light-green d-flex justify-content-between p-3 border-radius">
                    ...
                    <div>
                        ...
                        <p class="mb-0 text-end">AED {{ $total_commission }}</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="light-green p-3 border-radius" style="height: 600px;overflow: scroll;">
                    ...
                    @foreach ($activites as $activity)
                        <div class="active432 mt-4">
                            ...
                            <div class="@if ($activity->status == true) text-green @else text-red @endif">
            ...
            <div class="modal-content" style="height: 100%;">
                <div class="modal-header" style="border-bottom: 0px !important;">
                    <div class="w-100">
                        ...
                        <div>
                            ...
                            <p class=" text-center fw-900 light-gray-1 h-14">Submit your deal details to get your commission
                                advance. Fill in all required fields.</p>
                        </div>
                    </div>
                </div>
                <div class="modal-body" style="background-color:white;">
                    ...
                    <div class="step-container d-flex justify-content-between">
                        <div class="step-circle" onclick="displayStep(1)"><i class="fa-solid fa-paperclip me-2"></i> Details
                        </div>
                        ...
                        <div class="step-circle" onclick="displayStep(4)"><i
                                class="fa-solid fa-dollar-sign me-2"></i>Financial</div>
                        <div class="step-circle" onclick="displayStep(5)"><i class="fa-solid fa-check me-2"></i>Preview
                        </div>
                    </div>
                    <form id="multi-step-form" action="{{ route('deal.store') }}" method="POST">
                        ...
                        <div class="step step-1">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-controls w-100 fw-bold" value="Off plan"
                                    id="field1" name="project_type" readonly>
                            </div>
                            <div class="mb-3">
                                <label for="field1" class="form-label">Project Name</label>
                                <input type="text" class="form-controls w-100" id="field1"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-controls fw-bold w-100" id="field1" value=""
                                    name="city">
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="d-flex justify-content-end">
                                <button type="button" class="btn btn-green next-step">Next <i
                                        class="fa-solid fa-chevron-right me-2"></i></button>
                            </div>
                        </div>
                        ...
                        <div class="step step-2">
                            ...
                            <div class="mb-3">
                                ...
                                <input name="agent_name" type="text" class="form-controls w-100" id="agentName"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-controls w-100" id="brokerageName"
                                        name="brokerage_name" value="Livstate Real Estate Brokerage L.L.C" readonly>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-controls w-100" id="licenseNumber" value="1448140"
                                        name="brokerage_license_no" readonly>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="email" class="form-controls w-100" id="email" name="email"
                                        placeholder="Enter your email address">
                                </div>
                                <!-- Phone -->
                                <div class="col-md-6 mb-3">
                                    <label for="phone" class="form-label">Phone</label>
                                    <input type="tel" class="form-controls w-100" id="phone" name="phone"
                            ...
                            <div class="mb-3">
                                ...
                                <p>
                                    ...
                                    <span class="text-dark">for commission payment processing - all fields must be
                                        filled</span>
                                </p>
                            </div>
                            <div class="row">
                                <!-- SWIFT/BIC Number -->
                                <div class="col-md-6 mb-3">
                                    <label for="swift" class="form-label"><span class="text-danger">*</span> SWIFT/BIC
                                        Number</label>
                                    <input type="text" class="form-controls w-100" id="swift"
                                        placeholder="Enter SWIFT/BIC number" name="swift_number" required>
                                    <small class="text-muted">Bank identifier code (8-11 characters)</small>
                                </div>
                                <!-- IBAN Number -->
                                <div class="col-md-6 mb-3">
                                    <label for="iban" class="form-label"><span class="text-danger">*</span> IBAN
                                        Number</label>
                                    <input type="text" class="form-controls w-100" id="iban"
                                        placeholder="Enter IBAN number" name="iban_number" required>
                            ...
                            <div class="row">
                                <!-- Account Holder Name -->
                                <div class="col-md-6 mb-3">
                                    <label for="accountHolder" class="form-label"><span class="text-danger">*</span>
                                        Account
                                        Holder Name</label>
                                    <input type="text" class="form-controls w-100" id="accountHolder"
                                        placeholder="Enter account holder's full name" name="account_holder_name"
                                        required>
                                    <small class="text-muted">The name on the bank account that will receive
                                        payment</small>
                                </div>
                                <!-- Bank Country -->
                                <div class="col-md-6 mb-3">
                                    <label for="bankCountry" class="form-label"><span class="text-danger">*</span> Bank
                                        Country</label>
                                    <input type="text" class="form-controls w-100" id="bankCountry"
                                        placeholder="Enter bank country" name="bank_country" required>
                                </div>
                            </div>
                            <div class="d-flex justify-content-between">
                                <button type="button" class="btn btn-outlined prev-step"><i
                                        class="fa-solid fa-chevron-left me-2"></i>Previous</button>
                                <button type="button" class="btn btn-green next-step">Next<i
                        ...
                        <div class="step step-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-controls w-100" id="agentName"
                                    placeholder="Enter client's full name" name="client_name" required>
                            </div>
                            <div class="mb-3">
                                <label for="agentName" class="form-label">Is your client going to put down the initial 20%
                                    plus 4% DLD (Dubai Land Department) Fee?</label>
                            </div>
                            <div class="mb-3">
                            ...
                            <p class="h-14 fw-bold light-gray-1">This is required for eligibility for immediate commission
                                payout</p>
                            <div class="d-flex justify-content-between">
                                <button type="button" class="btn btn-outlined prev-step"><i
                                        class="fa-solid fa-chevron-left me-2"></i>Previous</button>
                        ...
                        <div class="step step-4">
                            ...
                            <div class="row mt-5">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" class="form-control" id="projectValue"
                                        placeholder="Enter project value" name="project_value">
                                </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" class="form-control" id="commissionPercentage"
                                        placeholder="Enter commission percentage" name="commission_percentage">
                                </div>
                            </div>
                            <div class="row">
                                <!-- Commission Amount -->
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" readonly class="form-control" id="commissionAmount"
                                        placeholder="Enter commission amount" name="commission_amount">
                                </div>
                                <!-- Deal Status -->
                                <div class="col-md-6 mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control" name="closing_date" id="closingDate"
